...
const WorkoutRunner = ({ workout, onComplete })=>{
        ...
        "WorkoutRunner.useEffect": ()=>{
            ...
            const interval = setInterval({
                "WorkoutRunner.useEffect.interval": ()=>{
                    setTimer({
                        "WorkoutRunner.useEffect.interval": (prev)=>{
                            const newState = {
                                ...prev
                            };
    ...
    const handleSetComplete = ()=>{
        ...
        if (timer.setIndex < totalSets - 1) {
            // More sets to do for this exercise - show rest period (paused)
            setTimer((prev_0)=>({
                    ...prev_0,
                    phase: 'rest-set',
                    countdownValue: 30,
            ...
            if (timer.exerciseIndex < workout.exercises.length - 1) {
                // More exercises to do - show rest period (paused)
                setTimer((prev_1)=>({
                        ...prev_1,
                        phase: 'rest-exercise',
                        countdownValue: 60,
    ...
    const currentSet = timer.setIndex + 1;
                    ...
                    children: [
                            ...
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                            children: [
                                                Math.round(timer.exerciseIndex / workout.exercises.length * 100),
                                                "%"
                                            ]
                                        }, void 0, true, {
                                            fileName: "[project]/src/components/workouts/WorkoutRunner.tsx",
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        style: {
                                            width: `${timer.exerciseIndex / workout.exercises.length * 100}%`
                                        }
                                    }, void 0, false, {
                                        fileName: "[project]/src/components/workouts/WorkoutRunner.tsx",
                                        lineNumber: 224,
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: timer.phase === 'countdown' ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                ...
                                children: [
                                    (timer.phase === 'rest-set' || timer.phase === 'rest-exercise' || timer.phase === 'countdown') && !timer.isRunning ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                        onClick: handlePause,
                                        className: "px-8 py-3 bg-green-600 hover:bg-green-700 text-white font-bold rounded-lg flex items-center gap-2 transition",
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$play$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Play$3e$__["Play"], {
...
_s(WorkoutRunner, "bos4oxe6UMeOpElsfeSOZDPJjGI=");
_c = WorkoutRunner;
/**
...
function RunWorkoutPage() {
    ...
    if ($[0] !== "13d0adcbecd824f6fcb568a90b66d289bd317bf9e3a92ace00ef2292fca69f9d") {
        for(let $i = 0; $i < 16; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "13d0adcbecd824f6fcb568a90b66d289bd317bf9e3a92ace00ef2292fca69f9d";
    }
    ...
    let t3;
    if ($[13] !== handleWorkoutComplete || $[14] !== workout) {
        t3 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ProtectedRoute$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
...
_s(RunWorkoutPage, "AKtsnkTBAKXQQKl8EIFSKoa5upI=", false, function() {
    return [
...
//# sourceMappingURL=src_a699d7c3._.js.map